...
@Component({
  selector: 'app-crud-orden-atencion-analisis',
  templateUrl: './crud-orden-atencion-analisis.component.html',
  styleUrls: ['./crud-orden-atencion-analisis.component.css']
})
export class CrudOrdenAtencionAnalisisComponent implements OnInit {
  ...
  cargarEditar() {
    this.api.get('orden_atencion_analisis', this.id).subscribe(
      (data) => {
        this.form = data
        }
      );
  ...
  registrar() {
    this.api.post('orden_atencion_analisis', this.form).subscribe(
      (data) => {
        this.return()
        }
      );
  ...
  editar() {
    ...
    this.api.put('orden_atencion_analisis', this.id, this.form).subscribe(
      (data) => {
        this.return()
        }
      );
