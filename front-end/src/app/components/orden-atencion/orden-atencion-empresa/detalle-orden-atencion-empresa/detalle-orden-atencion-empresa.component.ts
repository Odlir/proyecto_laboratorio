...
@Component({
  selector: 'app-detalle-orden-atencion-empresa',
  templateUrl: './detalle-orden-atencion-empresa.component.html',
  styleUrls: ['./detalle-orden-atencion-empresa.component.css']
})
export class DetalleOrdenAtencionEmpresaComponent implements OnInit {
  ...
  cargar(id) {
    this.api.get('orden_atencion_empresa', id).subscribe(
      (data) => {
        this.form = data
      }
    );
