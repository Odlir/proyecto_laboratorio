...
@Component({
  selector: 'app-detalle-orden-atencion-analisis-tipo-analisis',
  templateUrl: './detalle-orden-atencion-analisis-tipo-analisis.component.html',
  styleUrls: ['./detalle-orden-atencion-analisis-tipo-analisis.component.css']
})
export class DetalleOrdenAtencionAnalisisTipoAnalisisComponent implements OnInit {
  ...
  cargar(id) {
    this.api.get('orden_atencion_tipo_analisis', id).subscribe(
      (data) => {
        this.form = data
      }
    );
