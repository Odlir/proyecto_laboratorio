...
@Component({
  selector: 'app-detalle-muestras',
  templateUrl: './detalle-muestras.component.html',
  styleUrls: ['./detalle-muestras.component.css']
})
export class DetalleMuestrasComponent implements OnInit {
  ...
  cargar(id) {
    this.api.get('muestras', id).subscribe(
      (data) => {
        this.form = data
      }
    );
