    ...
    <div class="text-center text-secondary mt-caratula">
        ...
        <div class="mt">
            ...
            <div class="mt-persona">
                ...
                <p class="subtitulo mt-text">{{$persona->nombres}} {{$persona->apellido_paterno}}
        ...
        <div>
            ...
            <div>
                ...
                <div class="table-temperamento">
                    <h2 class="font-weight-bold text-secondary">Descripciones de los elementos del área {{$a->nombre}}
                    </h2>
                ...
                @if ($p->transformacion<0) @foreach ($p->formula->items as $i)
                    @if ($i->posicion=='0')
                    <div class="table-temperamento">
                        <h3 class="font-weight-bold">- {{$i->nombre}}</h3>
                        <p class="text-justify">{{$i->descripcion}}</p>
