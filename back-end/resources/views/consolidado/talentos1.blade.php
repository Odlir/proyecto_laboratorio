...
<body>
    ...
    <div>
        <p class="text-justify mx-3 mb-0">Tomando como base lo importante que es enfocarse en los talentos, la UPC ha
            desarrollado una herramienta para ayudar
            a identificar los talentos. A continuación se presenta un panorama de las categorías y de los talentos que
            se encuentran en
            cada una de ellas.</p>
    </div>
