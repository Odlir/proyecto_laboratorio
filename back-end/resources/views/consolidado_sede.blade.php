...
<body>
    ...
    <div class="page_break text-justify text-secondary">
        ...
        <div>
            ...
            <p>
                El proceso se inició dividiendo a los alumnos por sus respectivas secciones en dos salas de laboratorio
                del colegio.
            </p>

            <p>
                En la primera parte de la evaluación, el equipo de psicólogos evaluadores explicó a los alumnos, las
                instrucciones de acceso para la realización de cada uno de las pruebas virtuales.
            </p>

            <p>
                En dicha fecha, los alumnos se mostraron interesados y atentos ante las consignas brindadas por los
                evaluadores, realizando la prueba con concentración y rapidez. Las evaluaciones transcurrieron de manera
                fluida y sin ningún inconveniente.
            </p>
        </div>
        ...
        <div>
            ...
            <p>
                Las Tablas 3, 4, 5 y 6, presenta cuántos alumnos de la muestra total del colegio caen dentro de cada
    ...
    <div class="page_break text-justify text-secondary">
        ...
        <p>
            En la <b class="h3">Prueba de Intereses Profesionales</b>, los alumnos muestran mayor satisfacción con las
            actividades relacionadas
            al campo profesional Empresarial Administrativo Comercial, seguido por el campo Jurídico Social. En
            concordancia
            con esto, muestran también un alto conocimiento del primer campo de actividad señalado. Sobre las
            actividades que
            despiertan menor interés en ellos, están las relacionadas con los campos Científico, Informática,
            Artístico/Plástico,
            Sanitario, Comunicación/Información, Fuerzas Armadas y Deportivo. De estos campos, los cuatro últimos no
            obtienen tampoco
            un alto porcentaje en lo referente a conocimientos, lo que estaría indicando que el bajo interés de los
            alumnos de la muestra
            por estos campos podría obedecer a un escaso conocimiento sobre las actividades que se llevan a cabo en los
            mismos.
        </p>

        <p>
            En cuanto al <b class="h3">Test de Talento</b>, las dimensiones que aparecen con más frecuencia como
            dominantes son en primer lugar Flexibilidad
            (se adapta con facilidad al cambio), Idear (le gusta encontrar una forma sencilla para explicar por qué las
            cosas son como son),
            Empatía (ve al mundo a través de los ojos de los demás, comparte sus vivencias y perspectivas), Estratégico
            (ordena la confusión y
            encuentra el mejor camino para seguir adelante) e Inquisitivo (le gusta coleccionar infinidad de cosas,
            muchas cosas le resultan interesantes).
        </p>

        <p>
            Además, existe un predominio del Rol de Impacto (relacionado con la capacidad de motivar y liderar) seguido
            por el Rol de
            Pensamiento (relacionado con la capacidad de reflexión y búsqueda de la verdad) y el Rol de Relación
            (relacionado con el talento para
            manejar las relaciones humanas). El rol que aparece con menos frecuencia como dominante es el Rol de Empuje
