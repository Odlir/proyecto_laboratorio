...
class TalentosSeeder extends Seeder
{
    ...
    public function run()
    {
        $talentos=[
            ...
            ['tendencia_id'=>null,'tipo_id'=>2,'nombre'=>'Visual','descripcion'=>'Visual','imagen'=>'Visual.png','imagen_espalda'=>'Espalda Visual.png'],
            ['tendencia_id'=>null,'tipo_id'=>2,'nombre'=>'Espacial','descripcion'=>'Espacial','imagen'=>'Espacial.png','imagen_espalda'=>'Espalda Espacial.png'],
            ['tendencia_id'=>null,'tipo_id'=>2,'nombre'=>'Facilidad con los idiomas','descripcion'=>'Facilidad con los idiomas','imagen'=>'Facilidad con los idiomas.png','imagen_espalda'=>'Espalda Facilidad con los idiomas.png'],
            ['tendencia_id'=>null,'tipo_id'=>2,'nombre'=>'Artístico','descripcion'=>'Artístico','imagen'=>'Artistico.png','imagen_espalda'=>'Espalda Artistico.png'],
            ['tendencia_id'=>null,'tipo_id'=>2,'nombre'=>'Buen oído','descripcion'=>'Buen oído','imagen'=>'Buen oido.png','imagen_espalda'=>'Espalda Buen oido.png'],
            ['tendencia_id'=>null,'tipo_id'=>2,'nombre'=>'Facilidad para las ciencias naturales','descripcion'=>'Facilidad para las ciencias naturales','imagen'=>'Ciencias naturales.png','imagen_espalda'=>'Espalda Ciencias naturales.png'],
            ['tendencia_id'=>null,'tipo_id'=>2,'nombre'=>'Estético','descripcion'=>'Estético','imagen'=>'Estetico.png','imagen_espalda'=>'Espalda Estetico.png'],
            ['tendencia_id'=>null,'tipo_id'=>2,'nombre'=>'Motriz','descripcion'=>'Motriz','imagen'=>'Motriz.png','imagen_espalda'=>'Espalda Motriz.png'],
            ['tendencia_id'=>1,'tipo_id'=>2,'nombre'=>'Deportivo','descripcion'=>'Deportivo','imagen'=>'Deportivo.png','imagen_espalda'=>'Espalda Deportivo.png'],
