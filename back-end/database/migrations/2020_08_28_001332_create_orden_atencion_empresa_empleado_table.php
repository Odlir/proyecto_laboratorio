...
class CreateOrdenAtencionEmpresaEmpleadoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('orden_atencion_empresa_empleado', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('orden_atencion_empresa_empleado');
    }
}
