...
class CreateTalentoEMenosDesarrolladoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('talento_e_menos_desarrollado', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('talento_e_menos_desarrollado');
    }
}
